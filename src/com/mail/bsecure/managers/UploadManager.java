...
import com.mail.bsecure.services.UploadService;
...
public class UploadManager {
	...
	public boolean startService() {	
		...
		downloadIntent = new Intent(context, UploadService.class);		
		...
		callback.onStateChange(UploadService.DWL_START, 0, 0, "");

		return false;
	}

	public boolean isRunning() {
		return isServiceRunning(UploadService.class.getName());
	}
			...
			if (messenger != null) {
				try {
					Message msg = Message.obtain(null,
							UploadService.MSG_UNREGISTER_CLIENT);
					msg.replyTo = mMessenger;
					messenger.send(msg);
				} catch (RemoteException e) {
					//e.printStackTrace();
	...
	class IncomingHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case UploadService.DWL_START:
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;

			case UploadService.DWL_STOP:
				stopService();
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;

			case UploadService.DWL_PROGS:
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;

			case UploadService.DWL_COMPLT:
				//stopService();
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;
				
			case UploadService.DWL_INFO:
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;

			case UploadService.DWL_FAILED:
				//stopService();
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;

			case UploadService.DWL_CANCEL:
				stopService();
				callback.onStateChange(msg.what, msg.arg1, msg.arg2, msg.obj);
				break;
		...
		if (rawId != -1) {
			...
			if(messenger != null) {
				try {
					...
					Message msg = Message.obtain(null, UploadService.MSG_INFO_CLIENT);					
					msg.arg1 = (int)rawId;
					messenger.send(msg);
	...
	private long addTrackToDB(Item item) {
		...
		return getDataBaseObject().addTrack(track);
