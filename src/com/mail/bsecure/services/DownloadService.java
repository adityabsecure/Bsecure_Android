...
import com.mail.bsecure.tasks.HTTPGetTask;
import com.mail.bsecure.tasks.HTTPostJson;

public class DownloadService extends Service implements IRequestCallback, IItemHandler {
	...
	private void startDownloading() {
		...
		if(currentItem != null) {
			...
			sendMessageToUI(DownloadService.DWL_START, currentCount, totalCount, currentItem.getAttribute("TITLE"));	
